...
export const addupi = createAsyncThunk(
  "auth/upi",
  async (info, { rejectWithValue, fulfillWithValue }) => {
    try {
...
export const zilpayRecharge = createAsyncThunk(
  ...
  async ({amount,type}, { rejectWithValue, fulfillWithValue }) => {
    ...
    try {
      const { data } = await api.post("/webapi/zilpay", {amount:amount,type:type} ,{
        withCredentials: true,
      });
      return fulfillWithValue(data);
    } catch (error) {
...
export const p2p = createAsyncThunk(
  ...
  console.log("first",money,userId)
    try {
      const { data } = await api.post("/p2p", {money:money,userId:userId} ,{
        withCredentials: true,
      });
      return fulfillWithValue(data);
    } catch (error) {
...
export const getP2PByTransfer = createAsyncThunk(
  "auth/getP2PByTransfer",
  async (_, { rejectWithValue, fulfillWithValue }) => {
  
    try {
      const { data } = await api.get("/getP2PByTransfer",{
        withCredentials: true,
      });
      return fulfillWithValue(data);
    } catch (error) {
...
export const getP2PByPhone = createAsyncThunk(
  "auth/getP2PByPhone",
  async (_, { rejectWithValue, fulfillWithValue }) => {
  
    try {
      const { data } = await api.get("/getP2PByPhone",{
        withCredentials: true,
      });
      return fulfillWithValue(data);
    } catch (error) {
...
export const getP2PMain = createAsyncThunk(
  "auth/getP2PMain",
  async (_, { rejectWithValue, fulfillWithValue }) => {
  
    try {
      const { data } = await api.get("/getP2PMain",{
        withCredentials: true,
      });
      return fulfillWithValue(data);
    } catch (error) {
...
export const trasferToMain = createAsyncThunk(
  "auth/trasferToMain",
  async ({amount,password}, { rejectWithValue, fulfillWithValue }) => {
  
    try {
      const { data } = await api.post("/trasferToMain",{amount,password},{
        withCredentials: true,
      });
      return fulfillWithValue(data);
    } catch (error) {
    ...
    builder          
      ...
      .addCase(addusdt.fulfilled, (state, { payload }) => {
        ...
        state.loader = false;
         ...
         .addCase(addupi.pending, (state) => {
        state.loader = true;
      })
      .addCase(addupi.rejected, (state, { payload }) => {
        // console.log('register rejected payload:', payload); // Log payload
        state.errorMessage = payload?.errorMessage || "An error occurred";
        state.loader = false;
      })
      .addCase(addupi.fulfilled, (state, { payload }) => {
        state.successMessage = payload.message || "UPI Add Successfully";
        state.loader = false;
      })
     ...
     state.successMessage = payload.message;
       ...
       .addCase(p2p.rejected, (state, { payload }) => {
        state.successMessage = payload.message;
        state.p2ploader = false;
      })
      .addCase(getP2PByTransfer.pending, (state) => {
        state.loader = true;
      })
       .addCase(getP2PByTransfer.fulfilled, (state, { payload }) => {
          state.successMessage = payload.message;
        state.loader = false;
        state.P2PByTransferData=payload.data
      })
      .addCase(getP2PByPhone.pending, (state) => {
        state.loader = true;
      })
       .addCase(getP2PByPhone.fulfilled, (state, { payload }) => {
          state.successMessage = payload.message;
        state.loader = false;
        state.P2PByPhoneData=payload.data
      })
   
      .addCase(getP2PMain.pending, (state) => {
        state.loader = true;
      })
       .addCase(getP2PMain.rejected, (state, { payload }) => {
        // console.log('register rejected payload:', payload); // Log payload
        state.errorMessage = payload?.errorMessage || "An error occurred";
        state.loader = false;
      })
       .addCase(getP2PMain.fulfilled, (state, { payload }) => {
          state.successMessage = payload.message;
        state.loader = false;
        state.P2PMainData=payload.data
      })
      .addCase(trasferToMain.pending, (state) => {
        state.loader = true;
      })
       .addCase(trasferToMain.rejected, (state, { payload }) => {
        // console.log('register rejected payload:', payload); // Log payload
        state.errorMessage = payload?.errorMessage || "An error occurred";
        state.loader = false;
      })
       .addCase(trasferToMain.fulfilled, (state, { payload }) => {
          state.successMessage = payload.message;
        state.loader = false;
      })
