  ...
  return (
    <>
      ...
      <div className="container-section">
          ...
          <div className="mt-4">
            ...
            <div className="mt-3 flex justify-between relative">
              ...
              {loader ? (
                ...
                <span
                  className="absolute blue-linear right-3 top-2  color-orange cursor-pointer text-sm px-6 py-2 rounded-full"
                  onClick={handleOtp}
                >
                  Send
                </span>
        ...
        <button
          className="blue-linear flex justify-center  text-xl color-orange w-80  text-whites m-auto font-bold text-center  rounded-full p-2 mt-52 tracking-[3px]"
          onClick={submit}
        >
          Bind
        </button>
