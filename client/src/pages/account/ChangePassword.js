  ...
  return (
    <>
      ...
      <div className="container-section mt-10">
        <form action="" className="">
          <div className="mt-5">
            <div className="flex items-center">
              ...
              <label htmlFor="" className="font-medium ms-1 gray-text">
                Login Password
              </label>
            </div>
            <div className="mt-3 flex justify-between relative rounded-lg">
              ...
              <span
                ...
                className="absolute right-4 text-lg top-3 gray-text cursor-pointer"
              >
                {showPassword ? (
        ...
        <button
          className="blue-linear flex justify-center  text-xl  w-80   m-auto font-bold text-center  rounded-full p-2 mt-20 tracking-[3px] color-orange"
