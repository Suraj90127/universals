...
const Register = () => {
  ...
  const validateForm = (formData) => {
    ...
    if (!pwd) {
      ...
      newErrors.pwd =
        "Password must be at least 6 characters and include letters, numbers & a symbol.";
      valid = false;
    }
  ...
  return (
    <>
      ...
      <div className="bg-body px-4 pb-10 pt-2 text-white">
