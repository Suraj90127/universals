...
const K3 = () => {
  ...
  const { k3PeriodListData, k3HistoryData } = useSelector(
    ...
    // console.log("k3PeriodListData",k3PeriodListData);
      ...
      <div className="container-section relative mt-[-75px]">
        ...
        <div className="grid grid-cols-12 bg-popup-nav rounded-xl">
          ...
          >
            ...
            <p
              className={`text-center  fs-sm font-sans leading-4 ${
                activeTime == "1Min" ? "color-orange" : "gray-100"
              }`}
            >
              K3 Lotre <br /> 1Min
            </p>
          ...
          >
            ...
            <p
              className={`text-center  fs-sm font-sans leading-4 ${
                activeTime == "3Min" ? "color-orange" : "gray-100"
              }`}
            >
              K3 Lotre <br /> 3Min
            </p>
          ...
          >
            ...
            <p
              className={`text-center  fs-sm font-sans leading-4 ${
                activeTime == "5Min" ? "color-orange" : "gray-100"
              }`}
            >
              K3 Lotre <br /> 5Min
            </p>
          ...
          >
            ...
            <p
              className={`text-center  fs-sm font-sans leading-4 ${
                activeTime == "10Min" ? "color-orange" : "gray-100"
              }`}
            >
              K3 Lotre <br /> 10Min
            </p>
          ...
          <div className="bg-light p-3 mt-5">
            <div className="flex justify-between  rounded-lg ">
              <div>
                ...
                <h3 className="heading-h5 text-lg font-semibold mt-2 text-white">
              ...
              <div className="flex flex-col items-end">
                ...
                <div className="flex items-center mt-2">
                  ...
                  <span
                    className="sheet_nav_bg text-lg mx-[2px] font-semibold w-5 text-center color-l rounded"
                    id="minute"
                  >
                    {minutetime2}
                  </span>
            ...
            {selectTab == 1 && (
              <div>
                ...
                <div className="flex items-center text-white justify-center mt-4">
                  <button
        ...
        <div className="grid mt-5 grid-cols-12 gap-3">
          ...
          <div className="col-span-4 ">
            <button
              className={` flex justify-center items-center h-full w-full py-2 border-none rounded-lg ${
                gameHistory == "chart"
                  ? "text-base blue-linear  font-medium color-orange"
                  : "bg-light text-sm gray-100"
              }`}
        ...
        {gameHistory == "mhistory" && (
          <div className="bg-light p-2 py-3 mt-5">
            <div className="flex items-end justify-end mb-3">
              <Link className="text-blue fs-sm border rounded-lg border-[#c4933f] px-3 py-1 flex item-center items-end text-whites">
              ...
              k3HistoryData?.data?.gameslist?.map((item, i) => (
                <div key={i}>
                  ...
                  >
                    <div className="flex items-center">
                      <div
                        className={`flex font-semibold justify-center items-center h-10 w-10 rounded-lg mr-2 text-white
    ${
      /* 🔹 background colour */
      item.bet.split(",")[0] === "c"
        ? "bgs-green"
  ...
  `}
                  ...
                  >
                    ...
                    <div className=" flex flex-col    sheet_nav_bg p-1 mb-2  rounded-md">
      ...
      >
        <div className=" rounded-t-2xl text-white overflow-hidden w-full ">
          {selectTab == 1 && (
      ...
      {resultPopup && (winResult === true || winResult === false) && (
        <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center z-[9999]">
          ...
          <button
            className="text-white absolute bottom-[10%] text-2xl"
            onClick={() => handleClose()}
          >
      ...
      {openHowtoPlay ? (
        <div className="fixed top-32 bg-light w-[270px] flex flex-col justify-center items-center m-auto left-0 right-0 rounded-t-2xl rounded-b-2xl z-30">
          <div className=" blue-linear w-full text-center color-orange text-xl py-2  rounded-t-2xl">
            How to play
          </div>
          ...
          <div className="flex justify-center items-center bg-light w-full py-3 rounded-b-2xl">
            <button
              className="blue-linear rounded-full w-40 py-2 color-orange"
