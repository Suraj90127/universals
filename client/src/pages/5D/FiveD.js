  ...
  return (
    <>
      ...
      <div className="container-section relative mt-[-75px]">
        {/* time tabs */}
        <div className="grid grid-cols-12 sheet_nav_bg rounded-xl">
          <div
          ...
          >
            ...
            <p
              className={`text-center  fs-sm font-sans leading-4 ${
                activeTime == 1 ? "color-orange" : "gray-100"
              }`}
            >
              5D Lotre <br /> 1Min
            </p>
          ...
          >
            ...
            <p
              className={`text-center  fs-sm font-sans leading-4 ${
                activeTime == "3" ? "color-orange" : "gray-100"
              }`}
            >
              5D Lotre <br /> 3Min
            </p>
          ...
          >
            ...
            <p
              className={`text-center  fs-sm font-sans leading-4 ${
                activeTime == "5" ? "color-orange" : "gray-100"
              }`}
            >
              5D Lotre <br /> 5Min
            </p>
          ...
          >
            ...
            <p
              className={`text-center  fs-sm font-sans leading-4 ${
                activeTime == "10" ? "color-orange" : "gray-100"
              }`}
            >
              5D Lotre <br /> 10Min
            </p>
              ...
              <div className="grid grid-cols-10 gap-2">
                {Array.isArray(d5PeriodListData?.data?.gameslist) &&
                  d5PeriodListData?.data?.gameslist[0]?.result
                    ...
                    .map((data, i) => (
                      <div
                        className="col-span-2 flex justify-center items-center flex-col gray-50"
                        key={i}
                      >
                        <div className="w-9 flex justify-center items-center h-9 sheet_nav_bg rounded-full gray-50">
                          {data}
                        </div>
                        <p className="text-center text-sm gray-50">
                          {String.fromCharCode(65 + i)}
                        </p>
                      </div>
                    ))}
              </div>
              <span className="gray-50 mx-1  h-9 justify-center items-center flex">
                ={" "}
              </span>
              <div className="w-9 flex justify-center items-center text-sm h-9 bg-color-l2 text-black rounded-full">
                {Array.isArray(d5PeriodListData?.data?.gameslist) &&
                  d5PeriodListData?.data?.gameslist[0]?.result
                    ?.split("")
        ...
        <div className="bg-light relative p-3 mt-5 rounded-md">
          <div className="flex justify-between  rounded-lg ">
            <div>
              ...
              <h3 className="heading-h5 text-lg font-medium mt-2 gray-50">
            ...
            <div className="flex flex-col items-end">
              ...
              <div className="flex items-center mt-2">
                <span className="sheet_nav_bg text-lg mx-[2px] font-semibold w-5 text-center color-l rounded">
                  0
                </span>
                <span className="sheet_nav_bg text-lg mx-[2px] font-semibold w-5 text-center color-l rounded">
                  {minute2}
              ...
              d5PeriodListData?.data?.gameslist.map((item, i) => (
                <div className="grid grid-cols-12 bg-light p-2 py-3" key={i}>
                  <div className="col-span-5 flex text-center justify-center items-center">
                    <span className="text-sm text-[#f5f3f0] relative flex  ">
                      {item.period}
                    </span>
                  </div>
                  <div className="col-span-5 flex text-center justify-center  items-center">
                    {item?.result?.split("").map((data, i) => (
                      <div
                        key={i}
                        className="text-sm text-[#f5f3f0] w-6 h-6 flex justify-center items-center border-2 rounded-full  border-[--gray-400]"
                      >
                        {data}
                      </div>
                    ))}
                  ...
                  <div className="col-span-2  text-center flex justify-center m-auto  items-center">
                    <div className="text-sm w-6 h-6 flex justify-center items-center  rounded-full bg-color-l2 color-orange">
                      {String(item.result)
                        .split("")
                        .reduce((acc, digit) => acc + parseInt(digit), 0)}
                    </div>
            ...
            <div className="chart-section mt-5  rounded-t-md">
              <div className="bg-light pb-5">
                ...
                <div className="mx-2 mt-2">
                  ...
                  <div className="flex items-center justify-between mt-2">
                    <p className="text-sm text-[#f5f3f0]">Frequency</p>
                    <div className="grid grid-cols-10 gap-2">
                  ...
                  <div className="flex items-center justify-between mt-2">
                    <p className="text-sm text-[#f5f3f0]">Max consecutive</p>
                    <div className="grid grid-cols-10 gap-2">
                  ...
                  <ul id="trendList" className="w-full mt-5 fivedlist">
                    {Array.isArray(d5PeriodListData?.data?.gameslist) &&
                      d5PeriodListData?.data?.gameslist.map((item, i) => (
                        ...
                        >
                          <div className="first fs-sm text-[#f5f3f0] ">
                            {item?.period}
                          </div>
        ...
        {gameHistory == "mhistory" && (
          <div className="bg-light p-2 py-3 mt-5">
            <div className="flex items-end justify-end mb-3">
              <Link className="text-blue fs-sm border rounded-lg border-[#c4933f] px-3 py-1 flex item-center items-end ">
              ...
              d5HistoryData?.data?.gameslist?.map((item, i) => (
                <div key={i}>
                  ...
                  >
                    <div className="flex items-center">
                      <div
                        className={`flex justify-center text-white items-center h-10 w-10 rounded-lg mr-2 
                              ${
                                item.bet.split(",")[0] == "c"
                                  ? "bgs-green"
                                  : item.bet.split(",")[0] == "l"
                      ...
                      <div>
                        <h3 className="heading-h3 gray-text text-md">
                          {item?.stage}
                        </h3>
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between sheet_nav_bg p-1 mb-2 rounded-md">
                    ...
                    <div className="flex items-center justify-between sheet_nav_bg p-1 mb-2  rounded-md">
                      ...
                      <span className=" gray-50 ">₹{item.money}</span>
                    </div>
                    <div className="flex items-center justify-between sheet_nav_bg p-1 mb-2  rounded-md">
                    ...
                    <div className="flex items-center justify-between sheet_nav_bg p-1 mb-2  rounded-md">
                      ...
                      {item.status !== 0 && (
                        <div className=" flex text-center justify-center  items-center">
                          {item?.result?.split("").map((data, i) => (
                            <div className="text-sm gray-50 w-6 mr-1 h-6 flex justify-center items-center border-2 rounded-full  border-[--gray-400]">
                              {data}
                            </div>
                          ))}
                        </div>
                    ...
                    <div className=" flex justify-between items-center   sheet_nav_bg p-1 mb-2  rounded-md">
                      <p className="gray-50">Select</p>
                      <span className=" gray-50 flex">
                        {" "}
                        {item.bet == "c"
                          ? "Even"
                          : item.bet == "l"
                    ...
                    <div className="flex items-center justify-between sheet_nav_bg p-1 mb-2  rounded-md">
                      ...
                      <span className=" gray-50 ">{item.time}</span>
                    </div>
                  </div>
                </div>
              ))
      ...
      {/* popups */}
      <div
        className={`bg-light z-[12] items-center transition ease-in-out delay-150 justify-center fixed bottom-0 rounded-t-2xl filter-section w-[25.7rem] ${
          openPopup ? "flex" : "hidden"
        }`}
      >
        <div className=" rounded-t-2xl  overflow-hidden w-full ">
          <div className="px-4 pt-4">
            <div className="flex items-center mt-4 gray-50 border-b border-[--gray-400]">
              <button
                className={` text-lg font-bold  w-10 h-10  flex justify-center items-center abc-select relative mr-2 rounded-t-md ${
                  selectTab == "a"
                    ? " bg-color-l2 text-white after:bg-custom-radial-gradient"
            ...
            {selectTab != "total" ? (
              <div>
                <div className="grid grid-cols-12 mt-3 gap-2 ">
                  <div
                    className={`col-span-3 cursor-pointer gray-50  rounded-md font-medium text-base p-1 flex justify-between items-center ${
                      selectedNumbers.includes("b")
                        ? "bg-yellow text-white"
                        : "sheet_nav_bg"
                    }`}
                ...
                <div className="grid grid-cols-10 gap-2 ball-section mt-3">
                  {numbers3.map((number, i) => (
                    ...
                    >
                      ...
                      <div className="fs-sm gray-50">9</div>
                    </div>
                  ))}
                </div>
              </div>
          ...
          <div className="flex justify-between items-center">
            <button
              className="sheet_nav_bg gray-100 w-[40%] p-2 text-sm font-medium"
              onClick={() => {
                setOpenPopup(false);
                setSelectedNumbers([]);
              }}
        ...
        <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center z-[9999]">
          ...
          >
            ...
            <div className="flex items-center justify-center ">
              <button
                className={` text-md font-medium gray-50  w-7 h-8  flex justify-center items-center  relative mr-1 rounded-t-2xl color-yellow-bg-200 text-white`}
              >
                A
              </button>
              <button
              ...
              <button
                className={` fs-sm gray-50  w-7 h-8  flex justify-center items-center  relative rounded-t-2xl color-yellow-bg-200 text-white`}
              >
                SUM
              </button>
            </div>
            ...
            <p
              className={`fs-sm gray-50 text-center font-semibold ${
                winResult ? "mt-1" : "mt-3"
              }`}
            >
