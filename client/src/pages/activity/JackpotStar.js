    ...
    <>
      ...
      <div className="container-section mt-3">
        <div className="bg-body rounded-lg p-2 pb-5">
          ...
          <div className="grid grid-cols-12 sheet_nav_bg px-2 fs-sm py-1 rounded-md">
            <div className="col-span-6 gray-50">Game name</div>
            <div className="col-span-6 text-white"> Limbo</div>
          </div>
          <div className="grid grid-cols-12 sheet_nav_bg px-2 fs-sm py-1 rounded-md mt-1">
            <div className="col-span-6 gray-50">Number of wins</div>
            <div className="col-span-6 color-yellow-200 text-base"> 1.1X</div>
          </div>
          <div className="grid grid-cols-12 sheet_nav_bg px-2 fs-sm py-1 rounded-md mt-1">
            <div className="col-span-6 gray-50">Bonus</div>
            <div className="col-span-6 color-red-200 text-base"> ₹10.00</div>
          </div>
          <div className="grid grid-cols-12 sheet_nav_bg px-2 fs-sm py-1 rounded-md mt-1">
            <div className="col-span-6 gray-50">Winning time</div>
            <div className="col-span-6 gray-50"> 2024-06-18 12:03:06</div>
          </div>
        </div>
      </div>
    </>
