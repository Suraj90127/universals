  ...
  return (
    <>
      ...
      <div className="container-section mt-2 pb-5">
        <div className="grid grid-cols-12 sheet_nav_bg text-white rounded-t-md p-2 mt-2">
          ...
          <div
            className={
              i % 2 == 0
                ...
                : "grid grid-cols-12 sheet_nav_bg p-2 py-3"
            }
            key={i}
          >
            <div className="col-span-4 flex text-center justify-center">
        ...
        <div className="bg-body mt-5 px-2 pb-5">
          <div className="sheet_nav_bg w-[60%] text-white rounded-bl-full mb-2 py-1 rounded-br-full flex justify-center m-auto  font-bold text-base">
            Rules
          </div>
          <ul>
            <li className=" flex">
