  ...
  return (
    <>
      ...
      <div className="container-section mt-3">
        <div className="bg-body rounded-xl p-2 pb-0 text-white">
          ...
          <div className="sheet_nav_bg mt-3 w-[80%] px-3 py-2 rounded-md mb-2 gray-50 border-rounded fs-sm ">
            <span>Upgrade VIP level to increase rebet rate</span>
          </div>

          <div className="flex item-center justify-between mb-3">
            <div className="sheet_nav_bg  w-[49%] p-2 rounded-md">
        ...
        <div className="flex items-center mt-4 border-l-4 border-[#d9ac4f] text-sm">
          {" "}
          <h1 className="heading-h3 font-semibold ml-1 text-white">
            Rebate history
          </h1>
        </div>
        {Array.isArray(rebateData) &&
              ...
              <ul className="px-2 mt-2">
                <li className="flex  justify-between">
                  <div className="flex ">
                    ...
                    <p className="gray-50 text-sm ">Betting rebate </p>
                  </div>
                ...
                <li className="flex  justify-between">
                  <div className="flex ">
                    ...
                    <p className="gray-50 text-sm ">Rebate rate </p>
                  </div>
                ...
                <li className="flex  justify-between">
                  <div className="flex ">
                    ...
                    <p className="gray-50 text-sm ">Rebate amount</p>
                  </div>
