  ...
  return (
    <>
      ...
      <div className="container-section mt-5">
        <div className="flex justify-center items-center text-[#666462] fs-sm rounded-3xl bg-[#6F7381] p-3">
        ...
        <div
          className="flex mt-3 justify-center items-center color-orange fs-sm rounded-3xl blue-linear p-4 font-medium cursor-pointer"
          onClick={() => navigate("/")}
        >
          {" "}
          Go bet
