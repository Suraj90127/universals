...
const SettingCenter = () => {
  ...
  return (
    <>
      <CustomeNavbar name="Settings Center" bgClass="blue-linear" />

      <div className="blue-linear h-32 w-full rounded-b-[60px]"></div>
      <div className="container-section relative mt-[-120px]">
        <div className="sheet_nav_bg p-3 rounded-lg pb-8">
          ...
          >
            ...
            <Link className="flex items-center">
              <span className="text-base font-medium mr-2 gray-text">
                {userInfo?.name_user}
              </span>
              <MdOutlineArrowForwardIos className="text-lg gray-50" />
            </Link>
      ...
      <div className="container-section mt-8">
        <div className="flex items-center mt-2  border-l-4 border-[#c4933f] font-semibold">
          {" "}
          <h3 className="heading-h3 ml-1 text-white">Security information</h3>
        </div>
        <ul className="mt-3">
          <li className="mt-2 bg-body p-3 py-4 rounded-lg bg-body">
            ...
            >
              ...
              <div className="flex items-center">
                <span className="text-sm gray-50 mr-2">Edit</span>
          ...
          <li className="mt-4 bg-body p-3 py-4 rounded-lg bg-body">
            ...
            >
              ...
              <div className="flex items-center">
                <span className="text-sm gray-50 mr-2">to bind</span>
                <MdOutlineArrowForwardIos className="text-lg gray-text" />
              </div>
            </Link>
          </li>
          <li className="mt-4 bg-body p-3 py-4 rounded-lg bg-body">
            <Link className="flex justify-between items-center  ">
              ...
              <div className="flex items-center">
                <span className="text-sm gray-50 mr-2">1.0.9</span>
                <MdOutlineArrowForwardIos className="text-lg gray-text" />
              </div>
            </Link>
          </li>
      ...
      >
        <div className="absolute top-32  z-50  right-2 p-3 left-2 flex flex-col m-auto rounded-lg nav-bg">
          ...
          <div className="bg-body p-3 mt-4 rounded-lg">
            ...
            <input
              type="text"
              className="w-full mt-2 bg-[#282424] border border-slate-900 rounded-full p-2 focus:border-slate-700 ps-6 flex items-center focus:border focus:outline-none  placeholder:text-base placeholder:text-slate-500"
