...
import { gameHistory } from "../../store/reducer/spribeGameReducer";
...
const BetRecords = () => {
  ...
  const { gameHistoryData } = useSelector((state) => state.spribeGame)
  ...
  const [filtertag, setFilterTag] = useState("Lottery")
  ...
  useEffect(() => {
    dispatch(gameHistory({ phone: userInfo?.phone_user, page: 1, size: 10 }))
  }, [dispatch]);

  const handleClicks = (index, item) => {
    setActiveIndex(index);
    console.log("first",index,item)
    ...
    <>
      ...
      <div className="container-section">
        <div className="grid grid-cols-12 gap-2 mt-2">
          ...
          >
            <span className="text-base text-white">All</span>
            <span>
      ...
      {filtertag === "Lottery" ? (
            ...
            filteredData?.map((data, i) => (
              <div className="bg-body rounded-xl  mt-3 pb-4 pt-3" key={i}>
                <div className="flex justify-between items-center px-3">
                  <h3 className="heading-h3 font-semibold gray-text">
                    {data.game === "wingo10" ? "Wingo 30 sec" : data.game}
                  </h3>

                  <p
                    className={`text-base   ${data.status === 0
                        ? "color-yellow-200"
                        : data.status === 1
                          ? "color-green"
                          : "color-red-200"
                ...
                <p className="fs-sm px-3 gray-50 border-b border-color-slat leading-5">
                  {data.today}
                </p>
                <ul className="px-2 mt-2">
                  <li className="flex  justify-between">
                    <div className="flex ">
                      <div className="flex  flex-col items-center mt-[3px] mr-1">
                        <FaRegDotCircle className="blue-color-300 rounded-full fs-sm mr-1 border-b" />
                        {i < 5 ? (
                      ...
                      <p className="gray-50 text-sm ">Type </p>
                    </div>
                    <span className=" text-sm gray-50">{data.game}</span>
                  </li>
                  <li className="flex  justify-between">
                    <div className="flex ">
                      <div className="flex  flex-col items-center mt-[3px] mr-1">
                      ...
                      <p className="gray-50 text-sm ">Poriod </p>
                    </div>
                    <span className=" text-sm  gray-50">{data.stage}</span>
                  </li>
                  <li className="flex  justify-between">
                    <div className="flex ">
                      <div className="flex  flex-col items-center mt-[3px] mr-1">
                      ...
                      <p className="gray-50 text-sm ">Order number</p>
                    </div>
                  ...
                  <li className="flex  justify-between">
                    <div className="flex ">
                      ...
                      <p className="gray-50 text-sm ">Select</p>
                    </div>
                    <span className=" text-sm  gray-50">
                      {data.bet == "x"
                        ? "Green"
                  ...
                  <li className="flex  justify-between">
                    ...
                    <span className=" text-sm  gray-50">₹{data.amount}</span>
                  </li>
                </ul>
                ...
                <div className="px-3">
                  <div className="flex mb-5">
                    ...
                    <p className="text-base gray-text">Lottery Result</p>
                  </div>
                      ...
                      {(data.game.includes("wingo") ||
                        data.game.includes("trx")) && (
                          <div className="flex  items-center">
                            ...
                            />
                            <span
                              className={` text-base p-1 ms-2 rounded-md px-2  ${data.result >= 4 ? "bg-yellow" : "bgs-blue-500"
                                }`}
                            >
                              {data.result >= 4 ? "Big" : "Small"}
                            </span>
                            <span
                              className={`text-base p-1 ms-2 rounded-md px-2 ${data.result == "0"
                                  ? "bg-red-voilet"
                                  : data.result == "5"
                                    ? "bg-green-voilet"
                                    : data.result == 1 ||
                ...
                <div className="flex item-center justify-between mb-4 mx-3 mt-5">
                  <div className="sheet_nav_bg gray-text w-[48%] p-2 py-3 rounded-md flex justify-center items-center flex-col">
                    <p className="text-sm">₹{data.money}</p>
                    <p className="text-sm">Actual amount</p>
                  </div>

                  <div className="gray-text sheet_nav_bg w-[48%] p-2 rounded-md  flex justify-center items-center flex-col">
                    <p className="text-sm">
                ...
                <div className="flex item-center justify-between mb-3 mx-3">
                  ...
                  <div className="gray-text sheet_nav_bg w-[48%] p-2 rounded-md  flex justify-center items-center flex-col">
                    <p
                      className={`text-sm  ${data.status == 1 ? "gray-50" : "white"
                        }`}
                    >
                      {data.status == 2 ? "-" : ""}₹
                      {data.status == 1
        ...
        <div className="container-section mt-5">
          {gameHistoryData && gameHistoryData?.map((data, i) => (
            <div className='bg-body rounded-xl  mt-3 pb-4 pt-3' key={i}>
              <div className='flex justify-between items-center px-3'>
                <h3 className="heading-h3 font-semibold gray-text">{data.game_name}</h3>

                <p className={`text-base   ${data.status === 0 ? "color-yellow-200" : data.status === 1 ? "color-green" : "color-red-200"}`}>{data.status === 0 ? "Pending" : data.status === 1 ? "Win" : "Lose"}</p>
              </div>
              <p className='fs-sm px-3 gray-100 border-b border-color-slat leading-5'>{data.updated_at}</p>
              <ul className='px-2 mt-2'>
                <li className='flex  justify-between'>
                  <div className='flex '>
                    <div className='flex  flex-col items-center mt-[3px] mr-1'>
                  ...
                  <span className=' text-sm gray-100'>{data.game_type}</span>
                </li>
                ...
                <li className='flex  justify-between'>
                  ...
                  <span className=' text-sm  gray-100'>{data.game_uid}</span>
                </li>
                ...
                <li className='flex  justify-between'>
                  ...
                  <span className=' text-sm  gray-100'>₹{data.bet_amount}</span>
                </li>
              </ul>
              ...
              <div className='flex item-center justify-between mb-4 mx-3 mt-5'>
                <div className='sheet_nav_bg gray-text  w-[48%] p-2 py-3 rounded-md flex justify-center items-center flex-col'>
                  <p className='text-sm '>₹{data.bet_amount}</p>
                  <p className='text-sm '>Actual amount</p>
                </div>

                <div className='sheet_nav_bg gray-text w-[48%] p-2 rounded-md  flex justify-center items-center flex-col'>
                  <p className='text-sm '>₹{data.status == 1 ? data.win_amount : 0.00}</p>
                  <p className='text-sm '>Winnings</p>
                </div>
              </div>
              <div className='flex item-center justify-between mb-3 mx-3'>
                ...
                <div className='sheet_nav_bg gray-text w-[48%] p-2 rounded-md  flex justify-center items-center flex-col'>
                  <p className={`text-sm  ${data.status == 1 ? "color-green" : "color-red-200"}`}>{data.status == 2 ? "-" : ""}₹{data.status == 1 ? (Number(data.win_amount)).toFixed(2) - Number(data.bet_amount) : Number(data.bet_amount).toFixed(2)}</p>
                  <p className='text-sm '>Profit/loss</p>
                </div>
              </div>
      ...
      {openAll && (
        <div className="fixed z-[20] bottom-0 left-0 right-0 p-3 m-auto w-[25.7rem] rounded-t-xl nav-bg shadow-lg">
          <div className="grid grid-cols-12 gap-2 mt-2 mx-2">
            {allDate.map((item, i) => (
              <div
                key={i}
                className={`col-span-6 flex cursor-pointer  items-center p-2 rounded-md
                        ${isName == item.name ? "bg-color-l2 text-white" : "bg-body"}
                        `}
                onClick={() => {
              ...
              >
                ...
                <p className="ms-3 gray-50">{item.title}</p>
              </div>
            ))}
          </div>
        </div>
