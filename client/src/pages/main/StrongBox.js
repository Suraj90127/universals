  ...
  return (
    <>
      ...
      <div className="container-section mt-2  text-white ">
        ...
        <div className="mt-3 nav-bg pt-4">
          ...
          <div className="flex justify-between">
            <div className="flex justify-center items-center flex-col w-[50%] p-2">
              <button className="border w-full flex font-sans  justify-center items-center border-[var(--bgblue)] m-auto rounded-md p-2 mt-2 ">
        ...
        <button className="border w-full flex color-orange font-semibold  justify-center items-center border-[#dd9138] m-auto rounded-full p-2 mt-6 ">
