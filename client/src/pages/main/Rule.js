    ...
    <>
      ...
      <div className="container-section mt-2 pb-5">
          ...
          <div
            className={
              i % 2 == 0
                ...
                : "grid grid-cols-12 p-2 py-3 bg-[#282730]"
            }
            key={i}
          >
            <div className="col-span-4 flex text-center justify-center">
        ...
        <div className="mt-5 px-2 pb-5">
          <div className="sheet_nav_bg w-[60%] rounded-bl-full mb-2 py-1 rounded-br-full flex justify-center m-auto font-bold text-base text-white">
            Rules
          </div>
          <ul>
            <li className=" flex">
