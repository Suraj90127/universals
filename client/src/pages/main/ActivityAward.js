        ...
        <div className="container-section flex  justify-between">
          <div>
            <button className="">
              <Link to={"/activity"}>
                {" "}
                <IoIosArrowBack className="text-xl text-green-500" />
              </Link>
            </button>
          </div>
          <div>
          ...
          return (
            <div className="nav-bg rounded-xl mt-3" key={i}>
              <div className="flex justify-between items-center">
                ...
                <p className="text-slate-500 text-base mr-2 border-b border-slate-700  w-[55%] flex justify-end leading-9">
                  {buttonText}
                </p>
              </div>
              ...
              <div className="nav-bg mt-2 flex justify-between items-center mx-2 px-3 py-1 rounded-sm gray-100 text-sm">
              ...
              <div className="m-2 pb-4 pt-2">
                <button
                  className={` py-1 rounded-3xl text-base w-full border-green-500 border gray-100 heading-h3 text-green-500 font-semibold ${
