  ...
  return (
    <>
      ...
      <div className="container-section mt-2">
        <h1 className="heading-h1 text-center text-blue">
        ...
        <div className="bg-body mt-5 px-2 pb-5 rounded-md">
          <div className="sheet_nav_bg text-white w-[60%] rounded-bl-full mb-2 py-1 rounded-br-full flex justify-center m-auto  font-bold text-base">
            01
          </div>
        ...
        <div className="grid grid-cols-12 sheet_nav_bg text-white rounded-t-md p-2 mt-5">
