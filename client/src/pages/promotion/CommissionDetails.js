    ...
    <>
      ...
      <div className="container-section mt-5">
        <div className="bg-light rounded-md mt-3 pb-7 px-3 pt-1">
          <p className="text-sm gray-50"> Settlement successful</p>
          <p className="text-sm gray-50"> date</p>
          <p className="text-sm gray-50">
            {" "}
            The commission has been automatically credited your balance
          </p>
          <hr className="border-color-slat mt-1" />
          <div className="mt-3 flex justify-between items-center sheet_nav_bg gray-50 text-sm">
            <span className="text-sm">Number of bettors</span>
            <span className="text-sm  gray-50">{totals.userLevel}</span>
          </div>

          <div className=" flex justify-between sheet_nav_bg items-center mt-3 gray-50 text-sm">
            <span className="text-sm font-medium">Bet Amount</span>
            <span className="text-sm font-medium gray-50">
