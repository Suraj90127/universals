...
const games = [
  {
    ...
    label: "Game 1",
    image: "https://i.ibb.co/7xKY5LYm/8.png",
  },
  {
    apiKey: "562b299961b0ec40f252a832453c67b0",
    label: "Game 2",
    image: "https://i.ibb.co/35K1g3ZN/11.png",
  },
  {
  ...
  {
    apiKey: "2bd203129afe1059923b45d7bd5de143",
    label: "Game 31",
    image: "https://i.ibb.co/Zj9qgzp/squidgame.png",
  },
];
    ...
    <>
      ...
      <div className="flex justify-between items-center">
        <div className="flex items-center">
          <h1 className="border-after font-semibold mt-3 text-whites text-lg border-l-4 border-[#FF9800] pl-1">
            Chiken Road
          </h1>
        </div>
      </div>
