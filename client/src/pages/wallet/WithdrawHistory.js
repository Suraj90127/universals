      ...
      <div className="container-section mt-5">
        {filteredData?.length > 0 ? (
          ...
          filteredData.map((item, i) => (
            <div className="bg-body rounded-md pb-7 mb-4 pt-2" key={i}>
              <div className=" flex justify-between items-center px-2 text-sm py-1 rounded-sm sky-border border-b  ">
                <span className="text-sm font-medium bg-[#D23838] text-white p-1 px-3 rounded-md ">
                  Withdraw
                </span>
                <span
              ...
              <div className="mt-3 flex justify-between items-center gray-text text-sm px-2">
                ...
                <span
                  className={`text-sm font-medium color-yellow-200 ${
                    item.status === 0
                      ? "color-yellow-200"
                      : item.status === 1
                      ? "color-green"
