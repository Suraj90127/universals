...
const Wallet = () => {
  ...
  return (
    <Layout>
      ...
      <div className="nav-bg flex flex-col justify-center items-center py-4 text-white">
        <p>
      ...
      <div className="container-section mt-3">
        <div className="bg-body p-3 rounded-lg">
          ...
          <button
            className="blue-linear color-orange w-full p-1 text-lg font-bold my-2 rounded-full mt-3"
          ...
          <div className="flex justify-between mt-4 mx-2">
            <div onClick={() => navigate("/wallet/Recharge")}>
              ...
              <p className="text-sm gray-100 font-light text-center mt-2">
                Deposit
              </p>
            </div>
          ...
          {LotteryData.map((item, i) => (
            <div
              ...
              className={`col-span-4 rounded-md relative bg-light flex flex-col justify-center items-center  py-5 ${
                i === 0 ? "blue-linear color-orange" : "gray-50"
              }`}
            >
              ...
              <p className={`fs-sm ${i === 0 ? "color-orange" : "gray-100"}`}>
                {item.name}
              </p>
              <span
