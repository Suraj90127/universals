      ...
      <div className="payment-2">
        ...
        <div className="payment-selection-container">
          ...
          <div className="payment-grid">
            ...
            <button className="payment-button">
              <Image aria-hidden="true" alt="Paytm logo" src="https://i.ibb.co/vxYMkZcv/Paytm-Logo.png" />
            </button>
            <button className="payment-button">
              <Image aria-hidden="true" alt="PhonePe logo" src="https://i.ibb.co/ZPrPLcw/Phone-Pe-Logo.png" />
            </button>
            <button className="payment-button">
              <Image aria-hidden="true" alt="Google Pay logo" src="https://i.ibb.co/s9jjqKxH/Google-Pay-logo-500x281.png" />
            </button>
            <button className="payment-button">
              <Image aria-hidden="true" alt="UPI logo" src="https://i.ibb.co/xqmtJ4Fd/upi-logo-png-4.png" />
            </button>
          </div>
        </div>
        ...
        <div className="last">
          ...
          <div className="last-upi">
            ...
            <Image className="upi-img" src="https://i.ibb.co/vxYMkZcv/Paytm-Logo.png" alt />
            <Image className="upi-img" src="https://i.ibb.co/s9jjqKxH/Google-Pay-logo-500x281.png" alt />
            <Image className="upi-img" src="https://i.ibb.co/ZPrPLcw/Phone-Pe-Logo.png" alt />
          </div>
