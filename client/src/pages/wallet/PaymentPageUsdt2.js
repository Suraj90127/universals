  ...
  useEffect(() => {
    dispatch(rechargeGet()).then((res) => {
      ...
      setPay1(
        ...
        )}&pn=Merchant&am=${encodeURIComponent(rechargegetData?.money)}&cu=INR`
      );
    });
    ...
    <div className="bg-gray-200 ">
      <div className="bg-white p-1 py-3 sticky top-0 z-30">
        <div className="container-section flex items-center relative">
          <h1 className="heading-h1 text-[#2a2a2a] text-3xl font-semibold text-start">
            USDT
          </h1>
        </div>
      </div>
      <div className="bg-white font-sans p-5 mt-7">
        ...
        <div className="flex flex-col items-center justify-center mt-2">
          <div className="text-[#68aa9c] font-bold text-3xl">
            ${(rechargegetData?.money / 92)?.toFixed(2)}{" "}
            <span className="text-lg text-[#c7c7c7] ">(USDT)</span>{" "}
          </div>
          <div className="bg-[#68aa9c] text-white text-center p-1 w-[60%] mt-2 ">
            <button
              onClick={() => copyToClipCode2(typeid)}
        ...
        <div className="w-[30%] mx-auto mt-5 border-b-2 border-[#68aa9c]">
          <div className="text-xs text-[#68aa9c] text-center mb-1 font-medium ">
            USDT-BEP20
          </div>
        </div>
        ...
        <div className="flex justify-center">
          <div className="relative">
            <img src="/usdt2.jpeg" alt="QR Code" className="w-64 h-64" />
          </div>
        </div>
        ...
        <div className="mt-2">
          ...
          <div className="text-gray-400 font-semibold text-center">
            Please Pay within {String(minutes).padStart(2, "0")} minutes and{" "}
        ...
        <div className="flex items-center justify-center mt-4 ">
          <input
            ...
            className="bg-white border text-gray-500 intput-black focus:outline-none rounded px-3 py-1 w-full"
          />
          <button
      ...
      <div className="bg-white h-[6rem] relative bottom-[-96px]"></div>
    </div>
  );
};
