      ...
      <div className='container-section'>
          <div className="text-center mb-4">
            ...
            <div className="flex items-center justify-center mt-2">
              ...
              <button className="ml-2 blue-linear text-white px-3 py-1 rounded" onClick={copyToClipCode}>Copy</button>
            </div>
          </div>
        ...
        <div className="flex items-center justify-center mt-4">
          ...
          <button className="ml-2 blue-linear text-white px-3 py-1 rounded" onClick={handleSubmit}>Submit</button>
        </div>
      </div>
