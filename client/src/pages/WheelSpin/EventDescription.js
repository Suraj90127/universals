  ...
  return (
    <div className="min-h-screen bgs-body">
      ...
      <div className="bg-light h-[100px] rounded-lg mt-7 mx-4 ">
        <div className="flex items-center justify-start gap-3 blue-linear py-2 text-white px-2 text-[20px] -skew-x-12 ">
          <FaPlay className=" " />
          <h2>Activity time</h2>
        </div>
      ...
      {/* parahgraph */}
      <div className="bg-light h-[80px] rounded-lg my-5 text-[#c4933f] font-medium mx-4 flex items-center justify-center px-2 ">
