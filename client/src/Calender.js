...
function Calendar({ onDateSelect, onValueChange }) {
  ...
  return (
    <div className="">
      ...
      {isOpen && (
        <div className="fixed bottom-0 left-0 right-0 m-auto w-[25.7rem] z-50 rounded-t-xl shadow-lg bg-body">
          <div className="flex justify-between px-4 py-2 items-center rounded-t-xl sheet_nav_bg">
            <h2
            ...
            <h2 className="text-white font-bold text-md">Choose a Date</h2>
